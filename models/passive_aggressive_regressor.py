...
class PassiveAggressiveRegressorModel(BaseRegressor, PassiveAggressiveRegressor):
    ...
    ----------
        ...
        early_stopping (bool): Whether to use early stopping to terminate training when validation score does not improve.
                               Default is False.
        validation_fraction (float): The proportion of the training data to use as validation set when early stopping is enabled.
                                     Default is 0.1.
