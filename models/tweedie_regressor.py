...
class TweedieRegressorModel(BaseRegressor, TweedieRegressor):
    ...
    ----------
        power : float
            The power parameter in the Tweedie variance function. Default is 0.
        alpha : float
            The regularization parameter. Default is 0.5.
        link : str
            The link function to use. Default is "auto".
        max_iter : int
            The maximum number of iterations. Default is 100.
        tol : float
            The tolerance for the optimization algorithm. Default is 0.0001.
    """
